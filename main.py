...
def main():
    if len(sys.argv) > 1:
        ...
        elif cmd == "fast-import":
            fast_import(sys.argv[2:])
        elif cmd == "maintenance":
            maintenance(sys.argv[2:])
        elif cmd == "upload-pack":
            upload_pack(sys.argv[2:])
        elif cmd == "receive-pack":
            receive_pack(sys.argv[2:])
        elif cmd == "daemon":
            daemon(sys.argv[2:])
